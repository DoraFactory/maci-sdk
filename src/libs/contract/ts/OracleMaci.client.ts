...
export interface OracleMaciReadOnlyInterface {
  ...
  whiteInfo: ({ sender }: { sender: string }) => Promise<WhitelistConfig>;
  grantInfo: ({ grantee }: { grantee: string }) => Promise<GrantConfig>;
...
export class OracleMaciClient
  extends OracleMaciQueryClient
  implements OracleMaciInterface
{
